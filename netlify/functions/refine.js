        ...
        const payload = {
            contents: [{
                parts: [{
                    ...
                    지침:
                    1. 공백과 기호를 포함하여 **최대 500자 이내**로 작성하세요. 내용이 너무 길면 단어를 없애거나 줄임말을 사용해서 요약하세요.
                    2. '사용자님의 글을 다듬었습니다'와 같은 서론은 절대 하지 말고, 오직 **다듬어진 본문만** 출력하세요.
                    3. 원문의 종결 어미(예: '-한다', '-해요')를 **그대로 유지**하세요. 억지로 문체를 바꾸지 마세요.
                    4. 화려한 표현으로 바꾸지 말고 자연스럽고 담백한 한국어 문체를 사용하세요.
